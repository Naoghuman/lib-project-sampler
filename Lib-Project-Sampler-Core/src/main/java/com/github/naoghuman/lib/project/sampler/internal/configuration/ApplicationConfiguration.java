...
public interface ApplicationConfiguration {
    ...
    public static final String KEY__APPLICATION__RESOURCE_BUNDLE = "/com/github/naoghuman/lib/project/sampler/internal/application/application.properties"; // NOI18N
