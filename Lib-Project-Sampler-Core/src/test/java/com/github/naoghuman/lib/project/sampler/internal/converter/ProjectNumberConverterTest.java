...
/**
 * Test class for the class {@link com.github.naoghuman.lib.project.sampler.internal.converter.ProjectNumberConverter}
 *
 * @author Naoghuman
 * @since  0.1.0
 * @see    com.github.naoghuman.lib.project.sampler.internal.converter.ProjectNumberConverter
 */
public class ProjectNumberConverterTest {
    
    public ProjectNumberConverterTest() {
    ...
    public void testConvert_3_1() {
        ...
        String result = ProjectNumberConverter.convert(leadingZeros, projectOrSampleNr);
    ...
    public void testConvert_1() {
        int projectOrSampleNr = 1;
        String result = ProjectNumberConverter.convert(projectOrSampleNr);
